...
func configureFlags(command *cobra.Command) {
	...
	command.Flags().StringSlice("extracted-files-formats", []string{".md", ".yaml", ".html", ".xhtml", ".xml", ".txt", ".png"},
		"Supported content format extensions (example: .md, .html, .xhtml, .xml, .txt)")
