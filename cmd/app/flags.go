...
func configureFlags(command *cobra.Command) {
	...
	command.Flags().StringSlice("extracted-files-formats", []string{".md", ".yaml", ".txt", ".jpg", ".jpeg", ".gif", ".png"},
		"Supported content format extensions (example: .md, .yaml, .txt, .jpg, .jpeg, .gif, .png)")
