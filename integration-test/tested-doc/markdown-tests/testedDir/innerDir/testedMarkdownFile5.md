...
[test1](https://github.com/gardener/docforge/blob/master/integration-test/tested-doc/markdown-tests/testedMarkdownFile1.md)

### Link another file which is in the structure
[test2](https://github.com/gardener/docforge/blob/master/integration-test/tested-doc/markdown-tests/testedDir/testedMarkdownFile3.md)

### Link relatively file which is in the structure
[test3](../../testedMarkdownFile1.md)
