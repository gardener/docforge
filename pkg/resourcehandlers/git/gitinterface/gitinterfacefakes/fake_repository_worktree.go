...
type FakeRepositoryWorktree struct {
	CheckoutStub        func(*git.CheckoutOptions) error
	checkoutMutex       sync.RWMutex
	checkoutArgsForCall []struct {
		arg1 *git.CheckoutOptions
	}
...
func (fake *FakeRepositoryWorktree) Checkout(arg1 *git.CheckoutOptions) error {
...
func (fake *FakeRepositoryWorktree) CheckoutCalls(stub func(*git.CheckoutOptions) error) {
	fake.checkoutMutex.Lock()
	defer fake.checkoutMutex.Unlock()
	fake.CheckoutStub = stub
}

func (fake *FakeRepositoryWorktree) CheckoutArgsForCall(i int) *git.CheckoutOptions {
	fake.checkoutMutex.RLock()
	defer fake.checkoutMutex.RUnlock()
...
var _ gitinterface.RepositoryWorktree = new(FakeRepositoryWorktree)
