...
type FakeGit struct {
	PlainCloneContextStub        func(context.Context, string, bool, *git.CloneOptions) (gitinterface.Repository, error)
	...
	plainCloneContextReturns struct {
		result1 gitinterface.Repository
		result2 error
	}
	...
	PlainOpenStub        func(string) (gitinterface.Repository, error)
...
func (fake *FakeGit) PlainCloneContext(arg1 context.Context, arg2 string, arg3 bool, arg4 *git.CloneOptions) (gitinterface.Repository, error) {
...
func (fake *FakeGit) PlainCloneContextCalls(stub func(context.Context, string, bool, *git.CloneOptions) (gitinterface.Repository, error)) {
	fake.plainCloneContextMutex.Lock()
...
func (fake *FakeGit) PlainCloneContextReturns(result1 gitinterface.Repository, result2 error) {
	fake.plainCloneContextMutex.Lock()
	defer fake.plainCloneContextMutex.Unlock()
...
func (fake *FakeGit) PlainCloneContextReturnsOnCall(i int, result1 gitinterface.Repository, result2 error) {
	fake.plainCloneContextMutex.Lock()
	defer fake.plainCloneContextMutex.Unlock()
	fake.PlainCloneContextStub = nil
...
func (fake *FakeGit) PlainOpen(arg1 string) (gitinterface.Repository, error) {
...
func (fake *FakeGit) PlainOpenCalls(stub func(string) (gitinterface.Repository, error)) {
	fake.plainOpenMutex.Lock()
...
func (fake *FakeGit) PlainOpenReturns(result1 gitinterface.Repository, result2 error) {
	fake.plainOpenMutex.Lock()
	defer fake.plainOpenMutex.Unlock()
...
func (fake *FakeGit) PlainOpenReturnsOnCall(i int, result1 gitinterface.Repository, result2 error) {
	fake.plainOpenMutex.Lock()
	defer fake.plainOpenMutex.Unlock()
	fake.PlainOpenStub = nil
...
var _ gitinterface.Git = new(FakeGit)
