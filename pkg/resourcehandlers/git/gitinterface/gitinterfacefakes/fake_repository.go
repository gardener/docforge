...
type FakeRepository struct {
	FetchContextStub        func(context.Context, *git.FetchOptions) error
	fetchContextMutex       sync.RWMutex
	fetchContextArgsForCall []struct {
		arg1 context.Context
		arg2 *git.FetchOptions
	}
	...
	WorktreeStub        func() (gitinterface.RepositoryWorktree, error)
	worktreeMutex       sync.RWMutex
	worktreeArgsForCall []struct {
	}
	worktreeReturns struct {
		result1 gitinterface.RepositoryWorktree
		result2 error
	}
...
func (fake *FakeRepository) FetchContext(arg1 context.Context, arg2 *git.FetchOptions) error {
...
func (fake *FakeRepository) FetchContextCalls(stub func(context.Context, *git.FetchOptions) error) {
	fake.fetchContextMutex.Lock()
	defer fake.fetchContextMutex.Unlock()
	fake.FetchContextStub = stub
}

func (fake *FakeRepository) FetchContextArgsForCall(i int) (context.Context, *git.FetchOptions) {
	fake.fetchContextMutex.RLock()
	defer fake.fetchContextMutex.RUnlock()
...
func (fake *FakeRepository) Worktree() (gitinterface.RepositoryWorktree, error) {
...
func (fake *FakeRepository) WorktreeCalls(stub func() (gitinterface.RepositoryWorktree, error)) {
	fake.worktreeMutex.Lock()
	defer fake.worktreeMutex.Unlock()
	fake.WorktreeStub = stub
}

func (fake *FakeRepository) WorktreeReturns(result1 gitinterface.RepositoryWorktree, result2 error) {
	fake.worktreeMutex.Lock()
	defer fake.worktreeMutex.Unlock()
...
func (fake *FakeRepository) WorktreeReturnsOnCall(i int, result1 gitinterface.RepositoryWorktree, result2 error) {
	fake.worktreeMutex.Lock()
	defer fake.worktreeMutex.Unlock()
	fake.WorktreeStub = nil
...
var _ gitinterface.Repository = new(FakeRepository)
